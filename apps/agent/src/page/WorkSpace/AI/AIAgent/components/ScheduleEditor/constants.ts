...
export const TIMEZONES = [
  ...
  },
  {
    ...
    countryName: "Kenya",
    countryCode: "KE",
    mainCities: ["Nairobi", "Mombasa", "Ruiru", "Kikuyu"],
    rawOffsetInMinutes: 180,
    abbreviation: "EAT",
  ...
  },
  {
    ...
    countryName: "Indonesia",
    countryCode: "ID",
    mainCities: ["Makassar", "Denpasar", "Banjarmasin", "Manado"],
    rawOffsetInMinutes: 480,
    abbreviation: "WITA",
    rawFormat:
      "+08:00 Central Indonesia Time - Makassar, Denpasar, Banjarmasin, Manado",
  },
  {
    name: "Asia/Macau",
    alternativeName: "China Time",
  ...
  },
  {
    ...
    countryCode: "SG",
    mainCities: ["Singapore", "Woodlands", "Marine Parade"],
    rawOffsetInMinutes: 480,
    abbreviation: "SGT",
...
export const timezoneOptions = [
  ...
  {
    label: i18next.t("flow.editor.trigger.timezone.local"),
    value: ILLADayjs.tz.guess(),
  },
].concat(
  ...TIMEZONES.map((timezone) => ({
    label: `${timezone.abbreviation} - ${timezone.mainCities
      .slice(0, 2)
      .join(", ")}`,
    value: timezone.name,

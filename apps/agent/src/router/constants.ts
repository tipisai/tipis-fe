...
export const EDIT_FUNCTION_TEMPLATE_PATH = `${TEAM_IDENTIFIER_TEMPLATE_PATH}/function/:functionID/edit`
export const CREATE_FUNCTION_TEMPLATE_PATH = `${TEAM_IDENTIFIER_TEMPLATE_PATH}/function/create/:functionType`
